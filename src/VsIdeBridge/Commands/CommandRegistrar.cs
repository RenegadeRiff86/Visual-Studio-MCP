...
internal static class CommandRegistrar
{
    ...
    private static void RegisterCoreCommands(VsIdeBridgePackage package, IdeBridgeRuntime runtime, OleMenuCommandService commandService)
    {
        ...
        runtime.RegisterCommand(new IdeCoreCommands.IdeToggleHttpServerMenuCommand(package, runtime, commandService));
        ...
        runtime.RegisterCommand(new IdeCoreCommands.IdeLaunchVisualStudioCommand(package, runtime, commandService));
    ...
    private static void RegisterSolutionProjectCommands(VsIdeBridgePackage package, IdeBridgeRuntime runtime, OleMenuCommandService commandService)
    {
        ...
        runtime.RegisterCommand(new SolutionProjectCommands.IdeCreateProjectCommand(package, runtime, commandService));
        ...
        runtime.RegisterCommand(new SolutionProjectCommands.IdeRenameProjectCommand(package, runtime, commandService));
        ...
        runtime.RegisterCommand(new SolutionProjectCommands.IdeSetPythonProjectEnvCommand(package, runtime, commandService));
        runtime.RegisterCommand(new SolutionProjectCommands.IdeSetPythonStartupFileCommand(package, runtime, commandService));
        runtime.RegisterCommand(new SolutionProjectCommands.IdeGetPythonStartupFileCommand(package, runtime, commandService));
    }
}
