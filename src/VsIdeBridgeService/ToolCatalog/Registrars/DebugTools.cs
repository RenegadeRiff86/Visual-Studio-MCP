    ...
    private static IEnumerable<ToolEntry> BreakpointTools()
    {
        yield return BridgeTool("set_breakpoint",
            ...
            ObjectSchema(
                ...
                Opt("trace_message", "Tracepoint/logpoint message logged when hit. Supports {expression} interpolation (e.g. 'fan={fan_speed} out={m_output_fan_speed}'). Pair with continue_execution=true to log without pausing."),
